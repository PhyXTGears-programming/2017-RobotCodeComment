...
AddOutputFilter chunkFilter
		...
		<Item Name="0 - Team Code" Type="Folder">
		...
		<Item Name="Auto Code" Type="Folder">
			<Item Name="AutoAction.vi" Type="VI" URL="../AutoAction.vi"/>
			<Item Name="AutoDecoder.vi" Type="VI" URL="../AutoDecoder.vi"/>
			<Item Name="AutoForwardOrBack.vi" Type="VI" URL="../AutoForwardOrBack.vi"/>
			<Item Name="AutoLeftOrRight.vi" Type="VI" URL="../AutoLeftOrRight.vi"/>
		</Item>
		<Item Name="Auto-Teleop Code" Type="Folder">
			<Item Name="DriveControlerBuffer.vi" Type="VI" URL="../DriveControlerBuffer.vi"/>
			<Item Name="GearAiming.vi" Type="VI" URL="../GearAiming.vi"/>
			<Item Name="Shooting.vi" Type="VI" URL="../Shooting.vi"/>
		</Item>
		<Item Name="Pixy Code" Type="Folder">
			<Item Name="AverageWidth.vi" Type="VI" URL="../AverageWidth.vi"/>
			<Item Name="GetPixyObjectError.vi" Type="VI" URL="../GetPixyObjectError.vi"/>
			<Item Name="PixyGetFrame.vi" Type="VI" URL="../PixyGetFrame.vi"/>
			<Item Name="PixyGetObject.vi" Type="VI" URL="../PixyGetObject.vi"/>
			<Item Name="PixyHexDecode.vi" Type="VI" URL="../PixyHexDecode.vi"/>
		</Item>
		<Item Name="Teleop Code" Type="Folder">
			<Item Name="Climbing.vi" Type="VI" URL="../Climbing.vi"/>
			<Item Name="Gear Lift Intake.vi" Type="VI" URL="../Gear Lift Intake.vi"/>
			<Item Name="GearLoading.vi" Type="VI" URL="../GearLoading.vi"/>
			<Item Name="Manual Gear Aim.vi" Type="VI" URL="../Manual Gear Aim.vi"/>
			<Item Name="Thumper Control.vi" Type="VI" URL="../Thumper Control.vi"/>
		</Item>
		<Item Name="Zupport Code" Type="Folder">
